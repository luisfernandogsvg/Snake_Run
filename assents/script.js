...
// cor aleatoria da maça dependendo da coordenada
const randomColor = () => {
...
const drawSnake = () => {
  ctx.fillStyle = "#7345d6"

  snake.forEach((position, index) => {
    if (index == snake.length - 1) {
      ctx.fillStyle = "#0b8770"
    }
...
// indica a posição aleatória da maça 
...
// define aleatoriamente da cor da maça
    food.x = x
    food.y = y
